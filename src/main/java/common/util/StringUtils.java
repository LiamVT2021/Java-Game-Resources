...
public interface StringUtils {
    ...
    static String join(CharSequence delim, Stream<? extends CharSequence> stream) {
        return stream.collect(Collectors.joining(delim));
    }

    static String join(CharSequence prefix, CharSequence delim, CharSequence suffix, Stream<? extends CharSequence> stream) {
